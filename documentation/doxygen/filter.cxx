...
int main(int argc, char *argv[])
{
   ...
   gSource = (   EndsWith(gFileName, ".c")   || EndsWith(gFileName, ".C")   || EndsWith(gFileName, ".cc")
              || EndsWith(gFileName, ".cxx") || EndsWith(gFileName, ".cpp") || EndsWith(gFileName, ".c++")
              || EndsWith(gFileName, ".inl") || EndsWith(gFileName, ".m")   || EndsWith(gFileName, ".mm")
              || EndsWith(gFileName, ".pc"));
   gHeader = (   EndsWith(gFileName, ".icc") || EndsWith(gFileName, ".h")   || EndsWith(gFileName, ".hh")
              || EndsWith(gFileName, ".hxx") || EndsWith(gFileName, ".hpp") || EndsWith(gFileName, ".h++")
              || EndsWith(gFileName,".inc"));
   gPython = EndsWith(gFileName,".py");
